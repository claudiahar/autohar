    ...
    try {
      ...
      if (error) {
        ...
        toast({
          ...
          description: "A apărut o problemă. Încercați din nou sau sunați-ne direct.",
          variant: "destructive"
        });
        return;
      }
          ...
          <div className="grid lg:grid-cols-3 gap-10">
            ...
            <div className="lg:col-span-1 space-y-6">
              ...
              <div className="space-y-4">
                ...
                <a href="mailto:autohargrup@gmail.com" className="flex items-center gap-4 p-4 bg-card rounded-2xl border border-border hover:border-primary/50 transition-all duration-300 group">
                  <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-primary/20 to-primary/5 flex items-center justify-center group-hover:scale-110 transition-transform">
              ...
              <div className="bg-card p-6 md:p-8 rounded-2xl border border-border">
                {isSubmitted ? <div className="flex flex-col items-center justify-center py-16 text-center">
                    ...
                    <h2 className="font-display text-2xl md:text-3xl text-foreground mb-4">
                      Cerere <span className="text-accent">trimisă</span> cu succes!
                    </h2>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-10">
            <h2 className="font-display text-2xl md:text-3xl text-foreground mb-3">
              Unde ne <span className="text-primary">găsești</span>
            </h2>
